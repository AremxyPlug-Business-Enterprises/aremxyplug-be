...
type SmileResult struct {
	...
	ProductPlan            string `json:"network_product" bson:"network_product"`
	...
	TransactionDescription string `json:"description" bson:"transaction_description"`
...
type SpectranetResult struct {
	...
	OrderID                int    `json:"order_id" bson:"order_id"`
	TransactionID          string `json:"transcation_id" bson:"transaction_id"`
	ReferenceNumber        string `json:"reference_number" bson:"reference_number"`
	RequestID              string `json:"request_id" bson:"request_ID"`
}
